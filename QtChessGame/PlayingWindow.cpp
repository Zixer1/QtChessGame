...
PlayingWindow::PlayingWindow(QWidget* parent) {
    ...
    //  - TODO: turn into method with GUI namespace
    ...
    // Setting up the chess board GUI - TODO: turn into method with GUI namespace
    QImage chessBoard;
    ...
    // Load the logo - - TODO: turn into method with GUI namespace
    QImage chessLogo;
    ...
    // Setting up the border between the chess board and the score/pieces left  - TODO: turn into method with GUI namespace
